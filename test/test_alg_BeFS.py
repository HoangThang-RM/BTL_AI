...
class TestAlgBeFS(unittest.TestCase):  
    def setUp(self):
    ...
    def test_case_6(self):
        result = ['A', 'D', 'H', 'B']
        self.assertEqual( BeFS(self.pointList,"A","B"), result)
    
    # test case với trường hợp điểm bắt đầu là A và điểm đích là K
    def test_case_7(self):
        result = ['A', 'D', 'H', 'K']
        self.assertEqual( BeFS(self.pointList,"A","K"), result)
        
    # test case với trường hợp điểm bắt đầu là A và điểm đích là I
    def test_case_8(self):
        result = ['A', 'D', 'E', 'I']
        self.assertEqual( BeFS(self.pointList,"A","I"), result)
